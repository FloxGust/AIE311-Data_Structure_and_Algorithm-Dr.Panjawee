...
def quickSortHoare(arr, l_idx, h_idx):  # ฟังก์ชันสำหรับแบ่งอาร์เรย์โดยใช้ Hoare Partition Scheme
    
    mid = (l_idx + h_idx) // 2          # คำนวณหาค่าตำแหน่งตรงกลาง
    pivot = arr[mid]                    # หา Pivot โดยใช้ค่ามัธยฐานจากค่า กลาง (mid)
